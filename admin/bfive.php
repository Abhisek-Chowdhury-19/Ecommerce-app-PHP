    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Banner 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
if(isset($_POST['save_multiple_data']))
{
  ...
  if (move_uploaded_file($tempname, $folder)) {
    $qu="UPDATE banner1 set catid='$pid',title='' ,img='$dimg' ,fro='' WHERE sno=5";
    $runqu=mysqli_query($con,$qu);

    ?>
<script>
  alert("New Banner Added");
  window.location.href='bfive.php';
...
?>
    ...
    <div class="col-10">
             ...
             <img src="assets/img/Slider/banner_5.jpg" height=300px>
