...
if(isset($_POST['save_multiple_data']))
{
  ...
  if (move_uploaded_file($tempname, $folder)) {
    $qu="UPDATE banner1 set catid='$pid',title='$tname' ,img='$dimg' ,fro='$from' WHERE sno=4";
    $runqu=mysqli_query($con,$qu);

    ?>
<script>
  alert("New banner 4 Added");
  window.location.href='bfour.php';
...
?>
    ...
    <div class="col-10">
             ...
             <img src="assets/img/Slider/banner_4.jpg" height=300px>
