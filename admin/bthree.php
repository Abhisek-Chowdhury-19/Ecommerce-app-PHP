    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="bthree.php" class="active">
...
if(isset($_POST['save_multiple_data']))
{
  ...
  if (move_uploaded_file($tempname, $folder)) {
    $qu="UPDATE banner1 set catid='$pid',title='$tname' ,img='$dimg' ,fro='$from' WHERE sno=3";
    $runqu=mysqli_query($con,$qu);

    ?>
<script>
  alert("New benner Added");
  window.location.href='bthree.php';
...
?>
    ...
    <div class="col-10">
             ...
             <img src="assets/img/Slider/banner_3.jpg" height=300px>
