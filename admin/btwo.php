    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Banner 2</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
if(isset($_POST['save_multiple_data']))
{
  ...
  if (move_uploaded_file($tempname, $folder)) {
    $qu="UPDATE banner1 set catid='$pid',title='$tname' ,img='$dimg' ,fro='$from' WHERE sno=2";
    $runqu=mysqli_query($con,$qu);

    ?>
<script>
  alert("New banner Added");
  window.location.href='btwo.php';
...
?>
    ...
    <div class="col-10">
                 ...
                 <select id="Name" class="form-select"  name="Name" required>
                   ...
                   <?php
                     ...
                     while( $row_list = mysqli_fetch_array(
                         $query_result)){  
                             ?>
                             <option value="<?php echo $row_list['sno']; ?>">
               ...
               <br>
               <div class="col-4">
               <label for="inputName5" class="form-label">Cover Image 376 x 240</label>
              ...
              <div class="col-4">
               ...
               <input type="text" class="form-control" id="from" name="from" maxlength="90"  placeholder="Title 2" required>
...
<img src="assets/img/Slider/banner_2.jpg" height=300px>
