...
<head>
  ...
  <title>Pincode Manage-admin</title>
...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">All Pincode</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
<a href="pincodeadd.php">
<section class="section">
<button type="button" class="btn btn-primary" style="margin-left:80%;"><i class="bi bi-cart me-1"></i> Add Pincode</button>
</section>
</a>
...
<tr>
          ...
          <td>€'.$row1["deliveryfee"].'</td>


          <td><a href="pincodeupdate.php?pind='.$row1['sno'].'">
