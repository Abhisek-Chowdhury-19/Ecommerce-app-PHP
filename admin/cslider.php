...
<head>
  ...
  <title>Admin-Category Slider</title>
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            ...
            <li>
            <a href="cslider.php"    class="active">
...
if(isset($_POST['save_multiple_data']))
{
  ...
  $tempname2 = $_FILES["uploadfile2"]["tmp_name"];
  $folder2 = "assets/img/Slider/".$filename2.".jpg";

  if (move_uploaded_file($tempname, $folder) && move_uploaded_file($tempname2, $folder2)) {
    $qu="UPDATE cslider set catid='$pid',tname='$tname' ,dimg='$dimg' , mimg='$mimg' WHERE sno=1";
    $runqu=mysqli_query($con,$qu);

    ?>
<script>
  alert("New Product Slider Added");
  window.location.href='cslider.php';
...
?>
    <form class="row g-3" method="post" enctype="multipart/form-data">
               ...
               <br>
               <div class="col-4">
               <label for="inputName5" class="form-label">Cover Image Desktop 1920 x 782</label>
               <input type="file" name="uploadfile1" value="" required>
                         
              </div>
              <div class="col-4">
               <label for="inputName5" class="form-label">Mobile Image 480 x 400</label>
               <input type="file" name="uploadfile2" value="" required>
                         
              </div>
              <div class="col-4">

               <label for="inputName5" class="form-label">Title</label>
               <input type="text" class="form-control" id="tname" name="tname"  placeholder="Tilte name" required>
