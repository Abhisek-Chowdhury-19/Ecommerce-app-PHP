        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-order.php">
              <i class="bi bi-circle"></i><span>All Item</span>
            </a>
          </li>
          <!-- <li>
            <a href="components-po.php">
              <i class="bi bi-circle"></i><span>Manage Item</span>
            </a>
          </li> -->
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Menu Items <span>| Total</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                        <?php
                         $order="SELECT COUNT(item_id) FROM menu ";
...
?>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Open Order <span>| Total</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>      
                                        <?php
                         $order="SELECT COUNT(sno) FROM bgorder WHERE status!='Delivered' ";
                         $run=mysqli_query($con,$order);
                         $row=mysqli_fetch_array($run);
                         echo $row['COUNT(sno)'];
...
?></h6>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total User<span>| Total</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>  <?php
                         $order="SELECT COUNT(id) FROM userlogin ";
                         $run=mysqli_query($con,$order);
                         $row=mysqli_fetch_array($run);
                         echo $row['COUNT(id)'];
...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Open/ Close <span>| Today</span></h5>
    ...
    <div class="form-floating mb-3">
                      <select class="form-select" id="floatingSelect" name="status" aria-label="Floating label select example">
                        <option selected="">Open or Close the Store</option>
                        <option value="1">Open</option>
                        <option value="2">Close</option>
                        <!-- <option value="3">Three</option> -->
                      </select>
                      <label for="floatingSelect">Open or Close the Store</label>
                    </div>
                    <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name='store'>Update Status</button>
                  </div>
                  </form>
...
<?php
    if(isset($_POST['store'])){
      ...
      $check=$_POST['status'];
     if ($check=='1') {
     $open=mysqli_query($con,"UPDATE status set status='Open'  WHERE sno='1'");
  

     }
     else{
      $open=mysqli_query($con,"UPDATE status set status='Close'  WHERE sno='1'");
    ...
    ?>
<img src="open.png" alt="" style="width:100%; margin-top:50px;">
    ...
    <?php
        ...
        ?>
<img src="close.png" alt="" style="width:100%; margin-top:50px;">
