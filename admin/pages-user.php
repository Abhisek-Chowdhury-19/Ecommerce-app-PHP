...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">Searche</li>
...
if ($userdata['Role']=='Owner') {
 ...
 ?>
<a href="pages-adminmanage.php">
<section class="section">
<button type="button" class="btn btn-primary" style="margin-left:80%;"><i class="bi bi-person"></i> Manage Admin</button>
</section>
</a>
