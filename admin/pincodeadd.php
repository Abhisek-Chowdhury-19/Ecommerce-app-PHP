    ...
    <section class="section">
       <?php
         if(isset($_POST['save_multiple_data']))
         {
            ...
            $que="SELECT * from pincode WHERE pincode='".$Productname."'";
            $check_que=mysqli_query($con,$que);
                      if (mysqli_fetch_array($check_que)>0) 
                      {
                      echo '<script>alert("Pincode already there '.$Productname.'")</script>';
                      
                      }
                        else{
                            $addpincode=mysqli_query($con,"INSERT into pincode (pincode,min_order,deliveryfee) values ('$Productname','$minorder','$category')");
                        ...
                        <script>
                    window.location.href='pincodeadd.php';
                </script>
                <?php
