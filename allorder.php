...
<head>
    <meta charset="utf-8">
    <title>Green Indien Restaurant - All Order</title>
...
<div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="allorder.php" class="dropdown-item active">All Orders</a>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">All Orders</h1>
                <p>Track Now</p>
            </div>
                <table>
                    <tr>
                    ...
                    <?php
                    $id=$userdata['id'];
                    $orderdata=(mysqli_query($con,"select * from bgorder where c_id=$id"));
